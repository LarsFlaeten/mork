...
public:
               ...
               font(mork::Font::createFont("resources/fonts/LiberationSans-Regular.ttf", 48))
  {
      lampPos = mork::vec3d(-10.0/sqrt(2), -10.0/sqrt(2), 0.0);
        ...
        scene.getCamera().setFOV(radians(45.9));
    ...
    virtual void redisplay(double t, double dt) {
        ...
        prog.getUniform("material.ambient").set(mork::vec3f(1.0f, 0.5f, 0.31f));
        prog.getUniform("material.diffuse").set(mork::vec3f(1.0f, 0.5f, 0.31f));
        prog.getUniform("material.specular").set(mork::vec3f(0.5f, 0.5f, 0.5f));
